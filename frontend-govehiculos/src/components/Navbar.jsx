      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            {/* Si estamos en home y no autenticado → botón de login */}
            ...
            {/* Si el usuario está autenticado → mostrar info y logout */}
            {isAuthenticated && (
              <>
                {/* Bloque con enlaces, info y logout */}
                ...
                <div className="hidden md:flex items-center gap-3">
                  <div className="flex items-center gap-3 px-3 py-1.5 rounded-xl bg-white/5 border border-white/10">
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span
                        className={`text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded-md ${getRolColor(
                          userRolId,
                        )}`}
                      >
            ...
            <div className="px-4 py-4 space-y-1 max-h-[calc(100vh-4rem)] overflow-y-auto">
              <div className="flex items-center gap-3 px-3 py-3 mb-3 rounded-xl bg-white/5 border border-white/10">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span
                    className={`inline-block text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-md mt-1 ${getRolColor(
                      userRolId,
                    )}`}
                  >
                    {getRolName(userRolId)}
