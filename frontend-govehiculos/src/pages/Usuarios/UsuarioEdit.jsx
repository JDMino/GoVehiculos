  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-slate-500 font-medium">Cargando datos del usuario...</p>
      </div>
    </div>
  );
          ...
          <div className="bg-gradient-to-r from-slate-800 to-slate-900 p-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white tracking-tight">{form.nombre} {form.apellido}</h1>
                  <p className="text-slate-300 mt-1">Editando perfil de usuario</p>
                </div>
              </div>
          ...
          <form onSubmit={handleSubmit} className="p-8">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-sm font-semibold text-slate-900 uppercase tracking-wider">Informacion Personal</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">Telefono de Contacto</label>
            ...
            <div className="mb-8 pt-8 border-t border-slate-100">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-sm font-semibold text-slate-900 uppercase tracking-wider">Nivel de Acceso</h2>
              </div>

              <div className="max-w-md">
                <label className="text-sm font-medium text-slate-700 block mb-2">Rol del Usuario</label>
                <div className="relative">
                  <select
                    name="rolId"
                    value={form.rolId}
            ...
            <div className="mb-8 pt-8 border-t border-slate-100">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-sm font-semibold text-slate-900 uppercase tracking-wider">Estado de la Cuenta</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <label className={`relative flex items-center justify-between p-5 rounded-xl border-2 cursor-pointer transition-all ${
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="font-semibold text-slate-900 block">Cuenta Activa</span>
                      <span className="text-sm text-slate-500">Permitir acceso al sistema</span>
                    </div>
                  </div>
                  <div className="relative">
                    <input
                ...
                <label className={`relative flex items-center justify-between p-5 rounded-xl border-2 cursor-pointer transition-all ${
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="font-semibold text-slate-900 block">Bloquear Usuario</span>
                      <span className="text-sm text-slate-500">Restringir operaciones temporalmente</span>
                    </div>
                  </div>
                  <div className="relative">
                    <input
              ...
              {form.bloqueado && (
                <div className="mt-4 p-4 rounded-xl bg-amber-50 border border-amber-200 flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-amber-800">Usuario bloqueado</p>
                    <p className="text-sm text-amber-700">Este usuario no podra realizar operaciones en el sistema hasta que sea desbloqueado.</p>
                  </div>
                </div>
              )}
            </div>
